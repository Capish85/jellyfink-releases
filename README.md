...
To use merging, click **Load libraries** on the Servers tab. Next to each remote library a dropdown appears — choose an existing local library to merge into, or leave it on "— Create new library —" to keep it separate.
